...
\NewDocumentCommand{\commentRS}{O{}m}{\ifx&#1&\else\hl{#1} \fi\textcolor{red}{{\small$\big[$RS: #2$\big]$}}}
\NewDocumentCommand{\commentMN}{O{}m}{\ifx&#1&\else\hl{#1} \fi\textcolor{ao(english)}{{\small$\big[$MN: #2$\big]$}}}

...
H(\mathbf{P})={x, y} and for a rule f to satisfy RMD, we must have y element of f(P). However, Only alternatives $x$ and $y$ are in the first half. $RMD$ requires $y$ to be among the picked alternatives. Both $FB$(P) = $VR$(P)={$x$} thus both rules fail RMD. 

...
Let $\mathcal{MR}$ denote the class of minimally Rawlsian (MR) SCRs.
...
\end{theorem}
 \begin{proof}
	...
	when $m$ is even, $\PVcl ∩ \mathcal{MR} = \set{\PVe, \PVv[(\frac{m}{2}, \frac{m}{2} - 1)], \PVv[(\frac{m}{2} - 1, \frac{m}{2})]}$.\end{proof} 
...
\commentOC{I will take care of consistency for typography of classes of rules.}
\begin{proposition}

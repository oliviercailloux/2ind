...
At this example, SL picks both x and y thus we cannot conclude that it fails the principle but I am pretty sure we can find a profile where it fails the principle.

Using Theorem 2, I think the PV rules that are MR satisfy the principle.

...
\end{definition}
Thus, VR, SL and those rules in PV that fail WPEL all fail PEL. On the other hand, even the rules in PV that satisfy WPEL fail PEL.
\begin{proposition}
...
NOW: determine a version of Strong PEL that is sufficiently strong for incompatibility with MR. (Use an appropriately restricted class of measures sigma.)
Introduce (if we want to) MD as a refinement of that Strong PEL and, perhaps, study a rule that satisfies it. Variants of the definitions below could be useful.

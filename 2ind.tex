...
\begin{proposition}
	$\PVcl ∩ \FHcl = \set{\PVv \in \PVcl \suchthat v_i \geq \floor{\frac{m - 1}{2}}, \forall i }$. 
\end{proposition}
\begin{proof}
...
\begin{corollary}
	For $m$ odd, only $v_1=v_2=\frac{m-1}{2}$ is FH among $\PVcl$.
	For $m$ even, three SCRs are FH among $\PVcl$: $v_1=v_2=\frac{m}{2}-1$; $v_1=\frac{m}{2}$, $v_2=\frac{m}{2}-1$ and $v_1=\frac{m}{2}-1$, $v_2=\frac{m}{2}$.
\end{corollary}

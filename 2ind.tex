...
\commentRS{We agreed to start with a result on the emptiness (or not) of $H(\prof) \cap \argmin_{\PE} (d \circ \lprof)$ depending on the value of $m$; Theorem 3 and proposition 9 will follow as corollaries. Olivier will take care of this.}

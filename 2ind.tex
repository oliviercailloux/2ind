...
\commentMN{This conjecture seems correct. On the following extension, why do we want to refine it (i.e. make it more resolute)? Maybe anonymity is a nice property but the strong RMD rule is anonymous, right?}

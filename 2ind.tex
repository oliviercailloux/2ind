...
As the minimal Rawlsian and minimal dispersion principles are logically incompatible, the rules that satisfy MR (namely FB, VR, SL and the PV rules as described by Remark 4) all fail MD. This raises the question whether the PV rules that fail MR satisfy MD.

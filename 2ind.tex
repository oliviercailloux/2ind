...
\commentOC{I wonder if writing $\forall i: v_i ≥ \floor{\frac{m - 1}{2}}$ instead of $\PVcl^=$ would be better? It permits easier comparison with the other cases; OTOH it is probably less nice to read and perhaps more difficult to understand.}
	}
	\label{fig:propsC}
\end{table}

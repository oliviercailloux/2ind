...
\begin{proof}
	...
	Note that $\forall \prof$: $\lprofinv(\intvl{0, t} × \intvl{0, t}) \cap \PE \subseteq \PVv[(v_1, v_2)](\prof)$. 
	...
	Assume that $\max_{i \in \set{1, 2}} v_i > \frac{m + 1}{3}$ (thus $t < \frac{2m - 4}{3}$).
	Say $t = m - 1 - v_1$ (the rest of the argument applies symmetrically to the case $t = m - 1 - v_2$).

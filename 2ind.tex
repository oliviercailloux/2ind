...
\label{sec:intro}
\commentOC{Borda winners (R1 remark 6): I am against adding a footnote because the definition is just there already!} \commentRS{I agree}\commentMN{I agree}
\commentOC{R1 remark 9: we chose to keep Def 1 because of the centrality of this notion and because we have now added a remark following R2’s suggestion that refers to this notion. Def 4: similar IMHO. “all the discussion about the equal loss property could be placed in a footnote.”: I ignore which discussion this refers to.} \commentRS{I agree} \commentMN{So do I}
\commentOC{R1 r 10: I find this hurts readability, especially on \cref{fig:propsCexplicit} where the letter X might be thought to refer to something.} \commentRS{Instead of putting X, can we shade these cells?} \commentMN{I think that the empty cells really look like we do not know, we did not check and so on. An X, a shaded cell or some other symbol will help here}

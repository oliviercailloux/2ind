...
\commentOC{This phrasing suggests that we propose a bargaining solution with a disagreement outcome. I preferred the previous one: “We adopt their terminology, to avoid proposing a bargaining solution without a disagreement outcome”.}
...
\begin{remark}
  ...
  \commentOC{I split into two footnotes. Could we rather write (in both cases) “are compatible iff $k \geq \frac{2m - 4}{3}$”?}
\end{remark}

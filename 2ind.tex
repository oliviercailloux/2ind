...
\end{definition}
\commentRS{To be coherent with our new terminology PEL-Compatible and PEL, I renamed EL as EL compatible and the stronger version as EL. In the proposition below, the set EL must be ELC. There were phrasing issues with EL compatibility, which I tried to fix. I also changed SPEL to PEL.}
...
\commentRS{I propose to put Theorem 4 right after and Lemmata 2, 3, 4, 5 later, if possible to an appendix.}
...
\end{remark}
\commentRS{I propose to delete the theorem below but call Propositions 5, 6, 7, 8, 9 theorems.}

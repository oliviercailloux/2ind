...
Define the rule $MD(\prof) = \argmin_{\PE}(d \circ \lprof)$ which selects every Pareto efficient alternative that minimizes the dispersion. As mentioned in \cref{ft:equalarea}, this rule is the finite version of \possessivecite{thomson1994cooperative} equal area rule in our framework with no disagreement outcome. 

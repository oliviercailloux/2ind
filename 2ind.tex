...
\commentRS{Make MD stronger and see its impacts on Theorem 3, Proposition 9 and Proposition 10.}
...
\end{proof}
\commentRS{I think we don't need Theorem 4 below and the related material}
...
\lambda _{P}(y)_{1}=\lambda _{P}(x)_{1}-1$. As $x\in PE(\profc)$, we have $x\succ
...
\commentRS{The definition and the proposition below must be adapted to the new definition of MD.}

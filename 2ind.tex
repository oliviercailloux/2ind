...
\end{proof}
\commentRS{Thanks for the proof Matias. The way it is presented requires at least four alternatives while the theorem also covers the case of three alternatives. The profile should be changes so as to cover this as well.}
...
$\lprof(x)_1+\lprof(x)_2\geq m$. Thus, $\#\{y\in \mathcal{A}\mid y \succ_1 x\}+\#\{y\in \mathcal{A}\mid y \succ_2 x\}\geq m$, which implies $\{y\in \mathcal{A}\mid y \succ_1 x\}\cap \{y\in \mathcal{A}\mid y \succ_2 x\}\neq \emptyset$, contradicting $x \in \PE$.
	...
	\commentRS{I am happy to keep it.}

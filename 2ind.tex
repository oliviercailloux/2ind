...
The following result determine which rules in $\PVcl$ satisfy MR.
...
\begin{theorem}
	...
	\commentOC{That’s incorrect, isn’t it? We mean: $[\MRcl \cap \MDcl ≠ \emptyset]$ if and only if $m ≤ 6$ or $m = 8$.}
\end{theorem}
\begin{proof}
...
\commentOC{I don’t see how this claim follows from that theorem. Do we suggest that RMD is stronger than MR? That doesn’t seem correct to me.}

...
\begin{table}
  ...
  \caption{Summary of the results about $\FB$, $\VR$ and $\SL$.
    A tick (✓) means that the SCR satisfies the corresponding property for any value of $m ≥ 4$ \commentMN{and $n$, I think that we should remove it}.}%; a cross (✕) means that the opposite holds.}
  \label{fig:propsR}
\end{table}

...
Does FB satisfy the Upwards and Downwards Principles? Is it the only rule that satisfy those and LP and Pareto and LVC? Note that such a rule will hopefully prefer the losses (4, 4) to (2, 5) because (4, 4) indifferent to (1, 4), itself Pareto dominating (2, 5).

...
\color{red} Within the paper, we often refer to the most well-known rules in this environment: the Unanimity compromise, the veto-rank, the shortlisting and the Pareto-and-veto ones. We refer the reader to the review of the literature for a description of these rules. \color{black}

...
\begin{remark}
  ...
  for $m ≥ 3$, $k$-Rawlsianism (\cref{def:kr}) and MD are compatible for $k \geq \frac{2m - 4}{3}$ and incompatible for $k < \frac{2m - 4}{3}$.
  \footnote{Similarly, $k$-strict-Rawlsianism (\cref{ft:variant}) and MD are compatible for $k \geq \frac{2m - 4}{3}$ and incompatible for $k ≤ \frac{2m - 4}{3}$. We thank an anonymous reviewer for a question that lead to this observation.} 
\end{remark}

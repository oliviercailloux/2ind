...
As the minimal Rawlsian and minimal dispersion principles are logically incompatible, the rules that satisfy MR (namely FB, VR, SL and the PV rules identified by Theorem 2) all fail MD. As most PV rules fail MR, determining the class of PV rules that satisfy MD is of interest. As MD implies PEL, this will be a subclass of class of PV rules that satisfy PEL, which is identified by Proposition 5.
...
\commentRS{Look at the recent papers of Ozgur}

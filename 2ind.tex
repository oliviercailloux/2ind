...
\begin{remark}
	The equivalence $1 ⇔ 2$ says that in order ensure that an alternative that minimizes dispersion among the Pareto ones exists within the first $t$ alternatives for both players, it is necessary and sufficient to set $t$ at least $\frac{2m - 4}{3}$. As a matter of fact, by the anonymity of $\argmin_{\PE} (d \circ \lprof)$, ensuring this existence for the first $t$ alternatives for both players is equivalent to ensure it for the first $t$ alternatives for one of the players, as expressed by the equivalences $2 ⇔ 3$ and $2 ⇔ 4$. Thus, considering $1 ⇔ 3$ or $1 ⇔ 4$),  in order to ensure  that an alternative that minimizes dispersion among the Pareto ones exists within the first $t$ alternatives for one of the players, it is necessary and sufficient to set $t$ at least $\frac{2m - 4}{3}$.

...
\begin{theorem}
	...
	\end{enumerate}
\end{theorem}
	\commentRS{In the statement of Theorem 3, condition 2 implies 3 and 4 just by set inclusion, as we note in the proof. On the other hand, I think either of 3 and 4 implies 2 because of the anonymity of minimizing dispersion among Paretian alternatives. If so, then 2, 3, and 4 are equivalent independent of the choice of t,}
\begin{proof}
...
\commentRS{Proposition 9 seems to be complete and Matias checked it but another reading will be useful.}

...
\commentRS{As Olivier noted, we have to choose whether we keep the above approach or the one below. I prefer to go for the one above and discard the one below, which is for a stronger definition of MD, hence leading to a weaker impossibility.}

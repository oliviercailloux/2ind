...
\commentOC{If I dared, I’d propose something similar to the notations I suggested here above.}
...
\end{definition}
Thus, VR, SL and those rules in PV that fail WPEL all fail PEL. On the other hand \commentOC{Furthermore?}, even the rules in PV that satisfy WPEL fail PEL.
\begin{proposition}

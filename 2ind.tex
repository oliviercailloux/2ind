...
\begin{definition}[Strong equal loss (SEL)]
...
Start by defining MD restricted to MR alternatives (RMD).

RMD and MD are logically independent.

B doesn’t minimize dispersion among the Paretian alternatives within the first half. Look at the following profile with 11 alternatives.

x a b c d y w ……
e f g y x h w …….

FB bargaining picks x while y, which is also in the first half, has a lower dispersion.

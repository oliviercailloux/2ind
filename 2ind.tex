...
\Citet{cailloux2022compromising} propose a different conception of compromising based on an \textit{equal loss principle} that favors outcomes where every individual concedes as equally as possible from his highest ranked alternative. They show that several two-person social choice rules fail one variant of it \commentOC{This sentence feels odd. Can we write “… fail this principle”? Or “… fail this principle or some variant of it”? Or “… fail it”?}. \commentRS{I would go for “… fail this principle”}.
...
\commentOC{I believe that we should start by proving that all $\PVv$ rules are different.} \commentRS{I didn't get this}.
\begin{remark}
...
\commentOC{I find this quite difficult to understand. Could we move the interpretation after the theorem and proof?} \commentRS{As you wish}.
\begin{theorem}
	\label{th:pvmr}
...
\commentOC{Seems to me that we’re missing a sentence here that helps the reader understand the role of the following theorem. Something like: The next theorem will permit to establish the relationship of MD wrt the other classes of rules considered in this article.} \commentRS{I agree}.
...
\commentOC{I fear that this section looks a bit “quick and dirty”. I suggest to at least make the theorem more precise by specifying values of $m$ for which it holds (and thus generalize the proofs).} \commentRS{I agree}.

...
The \textit{veto-rank rule} where, for a number of alternatives $m$ being odd, each individual vetoes $(m - 1) / 2$ alternatives and ranks the remaining $(m+1) / 2$. The selected alternatives are those with the minimal sum of ranks among those that have not been vetoed.

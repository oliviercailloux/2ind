...
\commentMN{I think the section is good enough. It only suggests that out of the rules we considered only $PV^=$ passes the RMD test. I would leave it like this.}
\commentOC{I think that the result about PV= is nice, if correct, but I still have some doubts.}

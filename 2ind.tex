...
Note that we use the term “half” in a rather liberal way. We fix it at $\ceil{\frac{m - 1}{2}}$ because $\forall \prof \in \allprofs$, $\rhoP ≤ \ceil{\frac{m - 1}{2}}$, as shown by BK. \commentOC{TODO cite BK.}

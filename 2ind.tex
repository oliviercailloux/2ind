...
\end{proposition}
\begin{proof}
    \Cref{th:intersection} establishes, $\forall \prof$, the existence of an alternative $x \in \PE \cap H(\prof)$. Thus $d(\lprof(x)) ≤ \khalf$, proving the "if" part. \commentOC{Do we mean, the "only if" part?}
    For the other direction, consider the profile
	\begin{equation}
		\begin{array}{*8{l}}

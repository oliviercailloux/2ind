...
\begin{proof}
	...
	Observe that for any $y \in FB(\prof)$, $\max \lprof(y) ≥ \max \lprof(x)$ (as FB picks minimal worst loss alternatives). Thus, $y$ Pareto-dominates $x$. As also $x$ is Pareto-dominant, $x = y$.}
\end{proof}

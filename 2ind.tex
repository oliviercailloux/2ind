...
\begin{definition}[$k$-Rawlsianism] 
	\label{def:kr}
	Given $k \in \intvl{0, m - 1}$, a SCR is $k$-Rawlsian iff it selects alternatives whose losses are within $\intvl{0, k}$ for both individuals. 
	\commentOC{That does not match the formal definition, and does not match the informal description that follows the definition}
...
\commentOC{What do you think about replacing \cref{fig:propsC} by \cref{fig:propsCexplicit}?}

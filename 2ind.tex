...
\end{proposition}
It follows that the strongest  feasible version of $k$-Rawlsianism is that where $k$ equals $\khalf$.
We define “minimal Rawlsianism (MR)” as equal to $\khalf$-Rawlsianism because while $k$ is chosen to give the strongest general bound possible for every profiles, at a given profile, it is usually possible to do better (in terms of minimization of the worst loss).
